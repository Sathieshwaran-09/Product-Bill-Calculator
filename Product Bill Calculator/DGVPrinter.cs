...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Segoe UI", 8, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Segoe UI", 18, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Red;
            subtitlefont = new Font("Segoe UI", 11, FontStyle.Regular, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Segoe UI", 10, FontStyle.Bold, GraphicsUnit.Point);
